    ...
    <div class="container">
        <div class="col-md-12">
            <div id="main-slider" class="owl-carousel owl-theme" style="display: block; opacity: 1;">
                <div class="owl-wrapper-outer"><div class="owl-wrapper" style="display: block; width: 5504px; left: 0px; transition: all 400ms ease; transform: translate3d(-1376px, 0px, 0px);"><div class="owl-item" style="width: 688px;"><div class="item">
                ...
                <div class="owl-controls clickable"><div class="owl-pagination"><div class="owl-page"><span class=""></span></div><div class="owl-page"><span class=""></span></div><div class="owl-page active"><span class=""></span></div><div class="owl-page"><span class=""></span></div></div><div class="owl-buttons"><div class="owl-prev">prev</div><div class="owl-next">next</div></div></div></div>
            <!-- /#main-slider -->
        </div>
    </div>
    ...
    <div id="advantages">
        ...
        <div class="container">
            <div class="same-height-row">
                <div class="col-sm-4">
                    <div class="box same-height clickable" style="height: 208px;">
    ...
    <div id="hot">
        ...
        <div class="container">
            <div class="product-slider owl-carousel owl-theme" style="display: block; opacity: 1;">
                <div class="owl-wrapper-outer"><div class="owl-wrapper" style="display: block; width: 3840px; left: 0px; transition: all 0ms ease; transform: translate3d(0px, 0px, 0px);"><div class="owl-item" style="width: 240px;"><div class="item" style="visibility: visible;">
                                <div class="product">
                                ...
                                <!-- /.product -->
                            </div></div><div class="owl-item" style="width: 240px;"><div class="item" style="visibility: visible;">
                                <div class="product">
                                    <div class="flip-container">
                                        <div class="flipper">
                                            <div class="front">
    ...
    <div class="container animated fadeInUpBig" data-animate="fadeInUpBig" style="opacity: 0;">
        <div class="col-md-12">
            <div class="box slideshow">
                ...
                <div id="get-inspired" class="owl-carousel owl-theme" style="display: block; opacity: 1;">
                    <div class="owl-wrapper-outer"><div class="owl-wrapper" style="display: block; width: 4128px; left: 0px; transition: all 400ms ease; transform: translate3d(-1376px, 0px, 0px);"><div class="owl-item" style="width: 688px;"><div class="item">
                                    <a href="#">
