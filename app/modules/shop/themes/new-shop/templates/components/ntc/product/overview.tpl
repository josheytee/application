<div class="single-grids">
			...
			<div class="single-left">
				<div class="flexslider">
					<div class="flex-viewport" style="overflow: hidden; position: relative;">
						<ul class="slides"
							...
							<li data-thumb="/application/app/modules/shop/themes/new-shop/images/si2.jpg"
									...
									style="width: 314px; float: left; display: block;">
								<div class="thumb-image"><img src="/application/app/modules/shop/themes/new-shop/images/si2.jpg"
																							data-imagezoom="true" class="img-responsive"
																							draggable="false"></div>
							</li>
							<li data-thumb="/application/app/modules/shop/themes/new-shop/images/si.jpg"
					...
					<ol class="flex-control-nav flex-control-thumbs">
						<li><img src="/application/app/modules/shop/themes/new-shop/images/si.jpg" class="" draggable="false">
						</li>
						<li><img src="/application/app/modules/shop/themes/new-shop/images/si1.jpg" draggable="false" class="">
						</li>
	...
	<div class="col-md-3 single-grid1">
		...
		<div class="recent-grids">
			<div class="recent-left">
				<a href="single.html"><img class="img-responsive "
																	 src="/application/app/modules/shop/themes/new-shop/images/r.jpg" alt=""></a>
			</div>
		...
		<div class="recent-grids">
			<div class="recent-left">
				<a href="single.html"><img class="img-responsive "
																	 src="/application/app/modules/shop/themes/new-shop/images/r1.jpg" alt=""></a>
			</div>
			<div class="recent-right">
