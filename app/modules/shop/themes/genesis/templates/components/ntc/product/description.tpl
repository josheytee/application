                    ...
                    <div id="myTabContent" class="tab-content">
                        <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                            <div class="descr">
                                ...
                                <p class="quote">Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper
                                ...
                                <ul>
                                    ...
                                    <li> Material : Outer: 40% Linen &amp; 40% Polyamide; Body Lining: 100% Cotton;
                                        Lining: 100% Acetate
                                    </li>
                                </ul>
                                <p class="quote">Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper
                            ...
                            <div class="descr">
                                <div class="reviews-top">
                                    <div class="reviews-left">
                                        <img src="/application/app/modules/shop/themes/new-shop/images/men3.jpg" alt=" "
                                             class="img-responsive">
                                    </div>
                                    <div class="reviews-right">
                                        <ul>
                                            <li><a href="#">Admin</a></li>
                                            <li><a href="#"><i class="glyphicon glyphicon-share" aria-hidden="true"></i>Reply</a>
                                            </li>
                                        </ul>
